...
__all__ = ['MarketToDuke_Interpretation']
...
class MarketToDuke_Interpretation(ImageDataset):
    """DukeMTMC-reID.
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        self.key_attribute = ['backpack', 'bag', 'clothes', 'down', 'downblack', 'downblue', 'downbrown', 'downgray', 'downgreen', 'downpink', 'downpurple', 'downwhite', 'downyellow', 'gender', 'hair', 'handbag', 'hat', 'up', 'upblack', 'upblue', 'upgray', 'upgreen', 'uppurple', 'upred', 'upwhite', 'upyellow']
        ...
        super(MarketToDuke_Interpretation, self).__init__(train, query, gallery, **kwargs)
    ...
    def process_dir(self, dir_path, is_train=True):
        ...
        for img_path in img_paths:
            ...
            p_attribute = torch.ones(size=(26,))

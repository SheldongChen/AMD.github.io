...
__all__ = ['DukeMTMC_And_Interpretation']



@DATASET_REGISTRY.register()
class DukeMTMC_And_Interpretation(ImageDataset):
    """DukeMTMC-reID.
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        self.duke_attribute_path = osp.join(self.dataset_dir, 'duke_attribute_and.mat')
        ...
        super(DukeMTMC_And_Interpretation, self).__init__(train, query, gallery, **kwargs)
